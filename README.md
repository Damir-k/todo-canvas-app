# TODO: README
Ниже представлена README исходного репозитория, являющегося минимальным работающим React приложением. Данный репозиторий с того момента разрабатывается независимо.
